...
class RegressionModel(object):
    ...
    def run(self, x):
        ...
        """
        "*** YOUR CODE HERE ***"
        firstLayer = nn.ReLU(nn.AddBias(nn.Linear(x, self.w0), self.b0))
        secondLayer = nn.AddBias(nn.Linear(firstLayer, self.w1), self.b1)
        return secondLayer
...
class DigitClassificationModel(object):
    ...
    def run(self, x):
        ...
        "*** YOUR CODE HERE ***"
        firstLayer = nn.ReLU(nn.AddBias(nn.Linear(x, self.w0), self.b0))
        secondLayer = nn.ReLU(nn.AddBias(nn.Linear(firstLayer, self.w1), self.b1))
        thirdLayer = nn.AddBias(nn.Linear(secondLayer, self.w2), self.b2)
        return thirdLayer
